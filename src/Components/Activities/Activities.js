    ...
    return (
        <section className="activities my-5">
            ...
            <div className="container">
                    ...
                    <Fancybox options={{ infinite: false }}>
                        <div className="col-xl-3 col-lg-4 col-md-6 m-auto my-3">
                            ...
                            <div className="text-box">
                                ...
                                <p>
                                    <a href="#more-photos" className="btn" onClick={e => clickHandler(e, 'horse')}>View More Photos</a>
                                </p>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-4 col-md-6 m-auto my-3">
                            ...
                            <div className="text-box">
                                ...
                                <p>
                                    <a href="#more-photos" className="btn" onClick={e => clickHandler(e, 'pool')}>View More Photos</a>
                                </p>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-4 col-md-6 m-auto my-3">
                            ...
                            <div className="text-box">
                                ...
                                <p>
                                    <a href="#more-photos" className="btn" onClick={e => clickHandler(e, 'cooking')}>View More Photos</a>
                                </p>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-4 col-md-6 m-auto my-3">
                            ...
                            <div className="text-box">
                                ...
                                <p>
                                    <a href="#more-photos" className="btn" onClick={e => clickHandler(e, 'swing')}>View More Photos</a>
                                </p>
                            </div>
                        </div>
                    </Fancybox>
                ...
                {
                    hidden == false &&
                    <div className="hidden-images my-3" id="more-photos">
                        <h2>More Photos</h2>
                        {activity == 'horse' &&
                            <Horseriding />
                        }
                        ...
                        <div className="hide-button">
                            <button onClick={closeHandler}>Hide Images</button>
                        </div>
                    </div>
                }
            </div>
